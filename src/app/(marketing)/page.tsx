...
import HeroCanvasAnimation from "@/components/marketing/HeroCanvasAnimation";
...
export default function HomePage() {
  return (
    <div className="overflow-x-hidden">
      ...
      {/* ══════════════ SOCIAL PROOF BAR ══════════════ */}
      <section className="border-y border-[#1F2937] bg-[#0B0F19]" style={{ position: "relative", zIndex: 3 }}>
      ...
      <section id="how-it-works" className="py-40 bg-[#0B0F19]" style={{ position: "relative", zIndex: 3 }}>
        <div className="container-marketing">
          ...
          <div className="text-center mb-24">
            ...
            >
              From scattered to{" "}
              <span className="text-gradient-gold">strategic</span>
              <br />in four moves.
            </h2>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-shrink-0 z-10">
                      <div
                        className="w-16 h-16 rounded-full flex items-center justify-center font-data font-bold text-lg text-[#0B0F19] shadow-gold"
        ...
        <div className="container-marketing">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {BENTO_FEATURES.map((feat) => (
              <div key={feat.id} className={`card-feature group relative overflow-hidden ${feat.span} p-9`}>
                {/* Gold accent bar */}
                ...
                {/* Hover glow */}
                <div
                  className="absolute -bottom-8 -right-8 w-40 h-40 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-2xl"
      ...
      <section id="testimonials" className="py-40 bg-[#0B0F19]" style={{ position: "relative", zIndex: 3 }}>
        <div className="container-marketing">
          <div className="text-center mb-24">
            ...
            >
              Can&apos;t wait to review us?{" "}
              <span className="text-gradient-gold">We know&nbsp;;)</span>
            </h2>
            <p className="mt-5 text-[#9CA3AF] text-lg max-w-lg mx-auto leading-relaxed">
              Here&apos;s what the early intelligence network is saying.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t, i) => (
              <div
                key={i}
                className="glass-card rounded-2xl p-10 flex flex-col gap-6"
              >
                {/* Stars */}
      ...
      {/* ══════════════ FINAL CTA ══════════════ */}
      <section className="py-40 bg-[#0B0F19] overflow-hidden" style={{ position: "relative", zIndex: 3 }}>
        {/* Glow */}
        <div
        ...
        <div className="container-marketing relative z-10 text-center">
          ...
          <h2
            className="font-display font-bold text-[#F3F4F6] tracking-tight leading-[1.1] mb-8"
          ...
          <Link
            href="/onboarding"
            id="final-cta-button"
            className="btn-primary inline-flex h-16 px-14 text-lg rounded-xl gap-3"
          >
